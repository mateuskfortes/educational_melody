import { Chord as ChordClass, NoteBase, RestBase } from "@/classes/music-library/notes";
...
import { MusicNoteContainerPropsTemplate } from "@/types/music-library/ComponentsPropsTypes";
