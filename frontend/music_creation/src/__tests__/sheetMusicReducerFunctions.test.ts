...
describe('sheetMusicReducer functions (Whole = 4.0)', () => {
  ...
  describe('fillBdWithChords', () => {
    ...
    it('Should not return a dotted chord', () => {
      ...
      expect(result[0].notes[0].dots).toBe(0);
      expect(result[0].beatDuration).toBe(2.0);
      expect(result[1].notes[0]).toBeInstanceOf(Quarter);
      expect(result[1].beatDuration).toBe(1.0);
    })
  ...
  describe('mergeTiesAcrossMeasures', () => {
    ...
    it('Should merge ties across measures', () => {
      ...
      expect(measures[1]).toEqual(createMeasure(new Whole({ cleanNote: 'C', octave: 4 })))
    })
  ...
  describe('mergeRestsAcrossMeasures', () => {
    it('should not pop a measure that is not at the end of the sheet music', () => {
      ...
      expect(measures[1]).toEqual(createMeasure(new Whole({ cleanNote: 'C', octave: 5 })))
    })
    ...
    it('should pop the final measures if they are composed only of rests', () => {
      ...
      expect(measures[0]).toEqual(createMeasure(new Whole({ cleanNote: 'C', octave: 5 })))
    })
    ...
    it('should merge rests', () => {
      ...
      expect(measures[2]).toEqual(createMeasure(new Whole({ cleanNote: 'C', octave: 5 })))
    })
  })
