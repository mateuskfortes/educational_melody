...
import {
  ...
  NotesTemplate,
  SheetMusicItem,
} from "./_types/sheetMusicTemplates";
  ...
  measures: [
    {
      notes: [
        ...
        new Chord({
          ...
          notes: [
            { cleanNote: "C", octave: 5 },
            { cleanNote: "E", octave: 5 },
            { cleanNote: "G", octave: 5 },
          ],
        }),
        new Chord({
          noteConstructor: Eighth,
          notes: [
            { cleanNote: "D", octave: 5 },
            { cleanNote: "F", octave: 5 },
            { cleanNote: "A", octave: 5 },
          ],
        }),
        new Chord({
          noteConstructor: Eighth,
...
export default function MusicLibrary() {
  ...
  const [musicManageMode, setMusicManageMode] =
    useState<MusicManageModeType>("ADD");
  ...
  return (
    ...
    >
      ...
      <section className="tutorial">
        ...
        <Image src="images/music-library/mic.png" alt="" />
        <Image src="images/music-library/vinil.png" alt="" />
      </section>
